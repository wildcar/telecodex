...
class TelegramStreamEditor:
    ...
    async def finish(self, success: bool, summary: str, final_text: str | None = None, full_text: str = "") -> str:
        ...
        if not body:
            body = "Ответ пуст."
        try:
            await self.bot.edit_message_text(chat_id=self.chat_id, message_id=self.message.message_id, text=body)
