...
- При получении голосового сообщения бот сначала подтверждает прием отдельным сообщением, затем показывает краткий статус STT, удаляет его и выводит чистый транскрипт отдельным сообщением.
