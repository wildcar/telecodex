...
- В режиме выбора пути бот показывает список вложенных папок, позволяет заходить глубже, подниматься на уровень вверх и отдельно подтверждать текущую папку зеленой кнопкой.
